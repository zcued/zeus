...
export const Glyph = ({ glyph }) => {
  switch (glyph) {
    ...
    case 'hf-play':
      return (
        <g>
          <path d="M8.682.922L30.498 13.46c1.465.842 1.94 2.66 1.06 4.063a3.03 3.03 0 0 1-1.06 1.016L8.682 31.078c-1.464.841-3.363.386-4.241-1.016A2.868 2.868 0 0 1 4 28.538V3.461C4 1.826 5.384.5 7.092.5c.56 0 1.11.146 1.59.422z" />
        </g>
      )
    ...
    case 'hf-pause':
      return (
        <g>
          <path d="M5.28 1h3.756c.707 0 1.28.573 1.28 1.28v27.44A1.28 1.28 0 0 1 9.036 31H5.28A1.28 1.28 0 0 1 4 29.72V2.28C4 1.573 4.573 1 5.28 1zm17.684 0h3.756c.707 0 1.28.573 1.28 1.28v27.44A1.28 1.28 0 0 1 26.72 31h-3.756a1.28 1.28 0 0 1-1.28-1.28V2.28c0-.707.573-1.28 1.28-1.28z" />
        </g>
      )

    case 'hf-pause-circle':
      return (
        <g>
          <path d="M22.249 30.734c-5.825 2.468-12.815 1.328-17.563-3.42-6.248-6.249-6.248-16.38 0-22.628 6.249-6.248 16.38-6.248 22.628 0 5.271 5.272 6.095 13.307 2.472 19.443l-2.955-2.955c2.13-4.46 1.349-9.965-2.346-13.66-4.686-4.686-12.284-4.686-16.97 0-4.687 4.687-4.687 12.285 0 16.971a11.995 11.995 0 0 0 11.592 3.108l3.142 3.141zm1.88-.948l-2.955-2.955a11.915 11.915 0 0 0 1.78-1.049l2.858 2.858a15.93 15.93 0 0 1-1.683 1.146zm4.511-3.974a16.158 16.158 0 0 1-1.326 1.502l-2.829-2.829c.482-.482.914-.994 1.297-1.531l2.858 2.858z" />
          <path d="M18.6 11h1.8a.6.6 0 0 1 .6.6v8.8a.6.6 0 0 1-.6.6h-1.8a.6.6 0 0 1-.6-.6v-8.8a.6.6 0 0 1 .6-.6zM11.6 11h1.8a.6.6 0 0 1 .6.6v8.8a.6.6 0 0 1-.6.6h-1.8a.6.6 0 0 1-.6-.6v-8.8a.6.6 0 0 1 .6-.6z" />
        </g>
      )
      ...
      return (
        <g stroke="none" strokeWidth="1">
          <g transform="translate(5.000000, 3.000000)">
            <polygon points="12.8333333 14.7176471 16.8235294 10.8 22 10.8 11 21.6 0 10.8 5.17647059 10.8 9.16666667 14.7176471 9.16666667 0 12.8333333 0" />
